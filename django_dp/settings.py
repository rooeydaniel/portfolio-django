...
print "PATH: %s" % join(DJANGO_ROOT, SITE_NAME)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'django_dp.db',                      # Or path to database file if using sqlite3.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '65.203.19.125', 'ddc-django-default-project.herokuapp.com']
